import {resetState} from './adminSetting.js';
...
form2fa.addEventListener('submit', async(event)=> {
    ...
    try {
        let res = await makeRequest({method: "POST", url: `../settings/2fa/verify`, headers: {"Content-Type": "application/json;charset=UTF-8"}, data: {name: '2fa', type: true, adminToken: form2fa.elements[0].value, valueStr: totpSecret}});
